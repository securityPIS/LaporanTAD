...
export interface TripRow {
  ...
  // Diisi saat perencanaan (SPD) & dipakai lagi di Deklarasi.
  // sifat: "" | "residensial" | "non_residensial" — tampil di SPD ("Dinas
  // bersifat") sekaligus menentukan aturan klaim biaya (lihat lib/dinas-rules).
  sifat: string;
...
export const TABLE_COLUMNS: Record<TableName, string[]> = {
  ...
  // Kolom sifat/kendaraan/golongan/biaya_ditanggung ditambahkan DI AKHIR agar
